    ...
    <>
      ...
      >
        ...
        >
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(datasetOptions) && (
              <div className="lh-1 fs-5 fw-medium">Dataset</div>
            )}
            <RadioListGroup
          ...
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(measureOptions) && (
              <div className="lh-1 fs-5 fw-medium">Measure</div>
            )}
            <RadioListGroup
          ...
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(summaryColumnOptions) && (
              <div className="lh-1 fs-5 fw-medium">Summary Columns</div>
            )}
            <CheckboxListGroup
        ...
        <div className="bg-dark-subtle d-flex gap-3 p-3 rounded shadow-sm flex-column w-100">
          <div className="d-flex flex-column gap-2">
            <div className="lh-1 fs-5 fw-medium">Bar Chart</div>
            <div className="rounded shadow-sm overflow-hidden w-100">
              <Chart options={chartOptions}></Chart>
            </div>
          </div>
          <div className="d-flex flex-column gap-2">
            <div className="lh-1 fs-5 fw-medium">Pivot Table</div>

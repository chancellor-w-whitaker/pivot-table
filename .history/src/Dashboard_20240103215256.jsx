...
export const Dashboard = () => {
  ...
  return (
    <>
      <div className={`d-flex flex-wrap flex-${wrapBreakpoint}-nowrap gap-3`}>
        <div
          className={`d-flex gap-3 flex-row flex-wrap flex-${wrapBreakpoint}-column p-3 rounded shadow-sm w-100`}
        >

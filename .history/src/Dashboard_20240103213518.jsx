...
export const Dashboard = () => {
  ...
  return (
    <>
      <div className={`d-flex flex-column flex-${wrapBreakpoint}-row gap-3`}>
        <div
          className={`d-flex gap-3 flex-row flex-wrap flex-${wrapBreakpoint}-column p-3 rounded shadow-sm`}
        >
          <div className="d-flex flex-column gap-2">
            ...
            <RadioListGroup
              className="shadow-sm text-md-nowrap"
        ...
        <div className="w-100 shadow-sm rounded p-3"></div>
      </div>
    </>
  );
};

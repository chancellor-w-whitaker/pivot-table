...
export const Dashboard = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`ag-font-size d-flex gap-3 flex-row flex-wrap flex-${wrapBreakpoint}-column p-3 rounded shadow-sm flex-fill`}
        >
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(datasetOptions) && (
              <div className="lh-1 fw-medium">Dataset:</div>
            )}
            <RadioListGroup
          ...
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(measureOptions) && (
              <div className="lh-1 fw-medium">Measure:</div>
            )}
            <RadioListGroup
          ...
          <div className="d-flex flex-column gap-2">
            {isLengthyArray(summaryColumnOptions) && (
              <div className="lh-1 fw-medium">Summary Columns:</div>
            )}
            <CheckboxListGroup

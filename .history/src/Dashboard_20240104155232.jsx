...
export const Dashboard = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`bg-body-tertiary d-flex gap-4 p-3 rounded shadow-sm flex-row flex-${wrapBreakpoint}-column flex-wrap flex-fill`}
        >
        ...
        <div className="bg-body-tertiary d-flex gap-4 p-3 rounded shadow-sm flex-column w-100">
          <div className="d-flex flex-column gap-2">
